    ...
    <Tabs >
      <Tab title="6AM - 2PM" className="w-10/12">
        <CheckboxGroup defaultValue={keysConTrue || []}>
          ...
          <Checkbox lineThrough onValueChange={(value) => { handleStatus(22, "entranceToken", value) }} id="entranceToken" value="entranceToken">Realizar ficha de Portería</Checkbox>
      ...
      <Tab title="2PM - 10PM" className="w-10/12">
        <CheckboxGroup defaultValue={keysConTrue || []}>
          ...
          <Checkbox lineThrough onValueChange={(value) => { handleStatus(23, "entranceAfternoonToken", value) }} id="entranceAfternoonToken" value="entranceAfternoonToken">Realizar ficha de Portería</Checkbox>
